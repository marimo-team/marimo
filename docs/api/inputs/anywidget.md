...
- We've noticed that coding agents are getting better at generating these anywidgets on the fly. If you're keen to explore that you can check out our [anywidget skill example](../../guides/generate_with_ai/customize_your_agent.md#write-your-own-skills) for a quickstart.
