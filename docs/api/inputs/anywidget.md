...
- We've noticed that coding agents are getting better at generating these anywidgets on the fly. If you're keen to explore that you can check out our [prompts section](../../guides/generate_with_ai/prompts.md#anywidget) for a quickstart. 
