...
### How can I schedule marimo notebooks? 
...
In particular, you might be interested in running marimo notebooks as part of your [Github actions](https://docs.github.com/en/actions/reference/events-that-trigger-workflows#schedule) workflow. If so, feel free to modify the example from below. Note that this example does assume that you're using [inline dependencies](guides/package_management/inlining_dependencies). 
