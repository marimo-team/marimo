...
export default defineConfig([
    ...
    rules: {
        ...
        // "header/header": ["error", "block", "Copyright 2025 Marimo. All rights reserved."],
        ...
        // Throws an error: TypeError: Cannot read properties of undefined (reading 'some')
        ...
        "unicorn/no-array-reduce": "off", // false positives
    ...
    languageOptions: {
        parserOptions: {
            project: resolve(__dirname, "./e2e-tests/tsconfig.json"),
        },
    },
