...
export const AiProvidersConfig: React.FC<AiConfigProps> = ({
  ...
  const isConfigured = (name: FieldPath<UserConfig>) => {
    ...
    <SettingGroup>
      ...
      <Accordion type="multiple">
        <AccordionFormItem
          ...
          isConfigured={isConfigured("ai.open_ai.api_key")}
        >
          <ApiKey
            form={form}
            config={config}
        ...
        <AccordionFormItem
          title="Anthropic"
          provider="anthropic"
          isConfigured={isConfigured("ai.anthropic.api_key")}
        >
          <ApiKey
            form={form}
            config={config}
        ...
        <AccordionFormItem
          title="Google"
          provider="google"
          isConfigured={isConfigured("ai.google.api_key")}
        >
          <ApiKey
            form={form}
            config={config}
        ...
        <AccordionFormItem
          title="Ollama"
          provider="ollama"
          isConfigured={isConfigured("ai.ollama.base_url")}
        >
          <BaseUrl
            form={form}
            config={config}
        ...
        <AccordionFormItem
          title="GitHub"
          provider="github"
          isConfigured={isConfigured("ai.github.api_key")}
        >
          <ApiKey
            form={form}
            config={config}
        ...
        <AccordionFormItem
          ...
          provider="azure"
          isConfigured={
            isConfigured("ai.azure.api_key") &&
            isConfigured("ai.azure.base_url")
          }
        >
          <ApiKey
            form={form}
        ...
        <AccordionFormItem
          title="AWS Bedrock"
          provider="bedrock"
          isConfigured={isConfigured("ai.bedrock.region_name")}
        >
        ...
        <AccordionFormItem
          ...
          isConfigured={
            isConfigured("ai.open_ai_compatible.api_key") &&
            isConfigured("ai.open_ai_compatible.base_url")
          }
        >
          <ApiKey
            form={form}
