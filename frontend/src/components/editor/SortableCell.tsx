  ...
  (
    ...
    const dragHandle = (
      <div
        ...
        className="py-px cursor-grab opacity-50 hover:opacity-100 hover-action-stable hover:bg-muted rounded border border-transparent hover:border-border active:bg-accent"
      >
