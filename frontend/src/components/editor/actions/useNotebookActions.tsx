          ...
          ? {
              ...
              dropdown: [
                ...
                },
                {
                  ...
                  hidden: isWasm(),
                  rightElement: (
                    <span className="ml-3 shrink-0 rounded-full border border-emerald-200 bg-emerald-50 px-2 py-0.5 text-10 font-semibold uppercase tracking-wide text-emerald-700">
                      Recommended
                    </span>
                  ),
                  handle: () =>
