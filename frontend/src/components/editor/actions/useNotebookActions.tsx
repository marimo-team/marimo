...
export function useNotebookActions() {
  ...
  const actions: ActionButton[] = [
    ...
    },
    {
      ...
      handle: () => setCodeVisibility({ hidden: false }),
      redundant: true,
    },
    {
      ...
      handle: () => setCodeVisibility({ hidden: true }),
      redundant: true,
    },
    {
      icon: <EyeIcon size={14} strokeWidth={1.5} />,
      ...
      handle: () => setCodeVisibility({ hidden: false, markdownOnly: true }),
      redundant: true,
    },
    {
      icon: <EyeOffIcon size={14} strokeWidth={1.5} />,
      ...
      handle: () => setCodeVisibility({ hidden: true, markdownOnly: true }),
      redundant: true,
    },
    {
