...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="h-full pt-4 pb-1 px-1 flex flex-col items-start text-muted-foreground text-md select-none no-print text-sm z-50 dark:bg-background print:hidden hide-on-fullscreen border-r">
      {sidebarItems.map((p) => (
        <SidebarItem
          key={p.type}
          tooltip={p.tooltip}
