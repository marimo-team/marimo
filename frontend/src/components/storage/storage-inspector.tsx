    ...
    <>
      ...
      >
        ...
        <div className="flex items-center">
          {entry.size > 0 && (
            <span className="text-10 text-muted-foreground pr-2 tabular-nums">
          ...
          {entry.lastModified != null && (
            ...
            >
              <span className="text-10 text-muted-foreground pr-1 whitespace-nowrap">
    ...
    if (remoteSearch.status === "capped") {
      return (
        <span className="flex items-center gap-1.5">
          ...
          <span className="text-10">(or press Enter)</span>
        </span>
      );
    }
    ...
    <>
      ...
      >
        ...
        <RefreshIconButton
          ...
          iconClassName="h-3 w-3"
        />
        <span className="text-10 text-muted-foreground font-normal tabular-nums ml-auto">
