...
>(({ className, children, subtitle, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-hidden focus-visible:bg-accent focus-visible:text-accent-foreground",
      MENU_ITEM_DISABLED,
      className,
    )}
    {...props}
