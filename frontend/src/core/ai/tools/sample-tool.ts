...
export class TestFrontendTool extends BaseTool<typeof schema, typeof outputSchema> {
  constructor() {
    super({
      name: "test_frontend_tool",
      description: "A test frontend tool that returns hi with the name passed in",
      schema,
      outputSchema,
      mode: ["ask"],
    });
