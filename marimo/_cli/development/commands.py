...
def _generate_server_api_schema() -> dict[str, Any]:
    ...
    MODELS = [
        ...
        notification.ListPackagesResultNotification,
        notification.PackagesDependencyTreeResultNotification,
