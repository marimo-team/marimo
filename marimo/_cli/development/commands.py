...
from marimo._cli.print import get_colored_command_class, get_colored_group_class
...
@click.command(cls=get_colored_command_class(), help="""Print the marimo OpenAPI schema""")
def openapi() -> None:
    """
    Example usage:
...
@click.command(cls=get_colored_command_class(), help="Print all routes")
...
@click.command(cls=get_colored_command_class(), help="Preview a marimo file as static HTML")
@click.argument(
    "file_path",
    required=True,
    type=click.Path(
