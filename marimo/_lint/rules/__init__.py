...
RULE_CODES:  dict[str, type[LintRule]] = BREAKING_RULE_CODES | RUNTIME_RULE_CODES | FORMATTING_RULE_CODES

__all__ = ["RULE_CODES", "BREAKING_RULE_CODES",
           "RUNTIME_RULE_CODES", "FORMATTING_RULE_CODES"]
