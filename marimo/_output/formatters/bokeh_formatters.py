...
class BokehFormatter(FormatterFactory):
    ...
    def register(self) -> None:
        ...
        def _show_plot(
            ...
            from bokeh.embed import file_html  # type: ignore[import-not-found,import-untyped,unused-ignore] # noqa: E501
            from bokeh.resources import CDN  # type: ignore[import-not-found,import-untyped,unused-ignore] # noqa: E501
