...
def __(np, pd):
    data = {
        ...
        'LargeFloat': np.array([1.234567890123456789, 2.234567890123456789, 3.234567890123456789], dtype=np.float64),
        ...
        'Series': [pd.Series([1, 2, 3]), pd.Series([1, 2, 3]), pd.Series([1, 2, 3])],
