...
class TestRunCheck:
    ...
    def test_run_check_with_unsupported_files(self):
    ...
    def test_run_check_with_empty_py_file(self):
    ...
    def test_run_check_with_valid_notebook(self):
...
"""
    ...
    def test_run_check_with_syntax_error(self):
    ...
    def test_run_check_with_glob_patterns(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            txt_result = next(
                f for f in result.files if f.file.endswith(".txt")
            )
...
class TestFileStatus:
    ...
    async def test_file_status_fix_no_fixable_diagnostics(self):
    ...
    async def test_file_status_fix_with_fixable_diagnostics(self):
    ...
    async def test_file_status_fix_with_multiple_diagnostics(self):
...
class TestIntegration:
    ...
    def test_full_workflow_with_notebook_violations(self):
...
"""
            ...
            assert any(
                d.severity == Severity.FORMATTING
