...
def test_doesnt_have_shared_import(app) -> None:
    with app.setup:
        from tests._save.decorator_imports.transitive_imports import doesnt_have_import
...
def test_has_dep_with_differing_name_works(app) -> None:
    with app.setup:
        import marimo as mo
        from tests._save.decorator_imports.transitive_imports import doesnt_have_namespace as other
        from tests._save.decorator_imports.transitive_imports import doesnt_have_namespace_pinned as other_pinned
