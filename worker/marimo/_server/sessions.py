...
class Session:
    ...
    def __init__(
        ...
        session_consumer: SessionConsumer,
        queue_manager: AsyncQueueManager,
        # kernel_manager: RestartableTask,
        mode: SessionMode,
        app_metadata: AppMetadata,
        app_file_manager: AppFileManager,
    ) -> None:
        ...
        self.consumers: list[Callable[[Any], None]] = []

        def on_message(msg: Any) -> None:
            for consumer in self.consumers:
                consumer(msg)

        self.kernel_manager = launch_pyodide_kernel(
    ...
    def connect_consumer(self, session_consumer: SessionConsumer) -> None:
        ...
        self.consumers.append(subscribe)
        self.kernel_manager.start()
